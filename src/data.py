...
# jinja_env = Environment(loader=PackageLoader('qalcpad', 'shaders'))
...
GREEK_LETTERS = {
    ...
    'xi': 'ξ',
    'zeta': 'ζ',
    'hbar': 'ℏ', #not technically a greek letter but convenient to add here
}
...
FUNCTIONS = "asech acsch acosech acoth sech csch cosech coth asec acsc acosec acot arcsec arccsc arccosec arccot sec csc cosec cot asinh acosh atanh sinh cosh tanh asin acos atan arcsin arccos arctan sinc sin cos tan exp log ln lg sign sgn solve".split()
BINARY_OPERATORS = ("+", "-", "*", "=", " ")
